	...
	<?php if (!empty($this->sidebar)) : ?>
		...
		<?php else : ?>
			...
			<table class="table table-striped" id="einsatzberichtList">
                ...
                <th>
				<?php echo HTMLHelper::_('grid.sort',  'COM_EINSATZKOMPONENTE_EINSATZBERICHTE_ALERTING', 'a.alerting', $listDirn, $listOrder); ?>
				</th>
-->
						...
						<th class='left'>
							<?php echo HTMLHelper::_('grid.sort',  'COM_EINSATZKOMPONENTE_EINSATZBERICHTE_DATA1', 'a.data1', $listDirn, $listOrder); ?>
						</th>
						<th class='left'>
...
-->
							...
							if ($this->params->get('info112', '0')) :
								...
								if ($notrufticker == '1') {
									echo '<td align="center" nowrap="nowrap"><a class="link" id="link" href="' . Route::_('index.php?option=com_einsatzkomponente') . '&view=einsatzberichte&tickerID2=' . $item->id . '"><img src="../administrator/components/com_einsatzkomponente/assets/images/send.png" width="32" height="32" /></a></td>';
								}
