...
<?php require_once JPATH_SITE . '/components/com_einsatzkomponente/views/ausruestung/tmpl/' . $this->params->get('ausruestung_detail_layout', 'ausruestung_layout_1.php') . ''; ?> 