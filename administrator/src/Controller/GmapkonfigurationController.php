...
class GmapkonfigurationController extends FormController
{
  ...
  public function reset()
  {
    ...
    $reports_gmap_gmap_alarmarea =
      '53.28071418254047,7.416630163574155|53.294772929932165,7.4492458251952485|53.29815865222114,7.4767116455077485|53.31313468829642,7.459888830566342|53.29949234792138,7.478256597900327|53.29815865222114,7.506409063720639|53.286461382800795,7.521686926269467|53.26726681991669,7.499027624511655|';
    ...
    $query->set(
      '
		gmap_zoom_level = "' .
        $reports_gmap_gmap_zoom_level .
        '",
		gmap_onload = "' .
        $reports_gmap_gmap_onload .
        '",
		gmap_width = "' .
        $reports_gmap_gmap_width .
        '",
		gmap_height = "' .
        $reports_gmap_gmap_height .
        '",
		gmap_alarmarea = "' .
        $reports_gmap_gmap_alarmarea .
        '",
		start_lat = "' .
        $reports_gmap_start_lat .
        '",
		start_lang = "' .
        $reports_gmap_start_lang .
        '",
		state = "1",
		created_by ="1" '
    );
