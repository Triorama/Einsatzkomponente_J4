...
?>
    ...
    <?php foreach ($this->items as $i => $item): ?>
     ...
     ?>
      ...
      'index.php?option=com_einsatzkomponente&view=ausruestung&id=' . (int) $item->id
    ); ?>" class="btn btn-primary" role="button"><?php echo Text::_(
  'COM_EINSATZKOMPONENTE_DETAILS_2'
); ?></a></p>
				</td>
					...
					<td class="center">
						<?php if ($canEdit): ?>
							<a href="<?php echo Route::_(
         'index.php?option=com_einsatzkomponente&view=ausruestungform&id=' . $item->id
