...
?>
	<table class="table" id="fahrzeugList">
      ...
      $listOrder
				...
				<?php echo HTMLHelper::_(
      'grid.sort',
      'COM_EINSATZKOMPONENTE_EINSATZFAHRZEUGE_BESCHREIBUNG',
      'a.detail1',
      $listDirn,
      $listOrder
    ); ?>
				...
				><?php echo Text::_('COM_EINSATZKOMPONENTE_LETZTER_EINTRAG'); ?>
				</th>
				<?php endif; ?>
				
				<?php if ($this->params->get('show_fahrzeuge_orga', '1')): ?>
				<th  class="eiko_einsatzfahrzeug_organisation  mobile_hide_480">
				<?php echo Text::_('COM_EINSATZKOMPONENTE_ORGANISATION'); ?>
				</th>
				<?php endif; ?>

							<?php if ($canEdit || $canDelete): ?>
					<th class="eiko_admin_action center">
				<?php echo Text::_('COM_EINSATZKOMPONENTE_ADMIN_ACTION'); ?>
				</th>
				<?php endif; ?>
...
<?php if (!$this->params->get('eiko')): ?>
        <tr><!-- Bitte das Copyright nicht entfernen. Danke. -->
            <th colspan="<?php echo isset($this->items[0])
              ? count(get_object_vars($this->items[0]))
              : 10; ?>"><span class="copyright">Einsatzkomponente V<?php echo $this->version; ?>  (C) 2018 by Ralf Meyer ( <a class="copyright_link" href="https://einsatzkomponente.de" target="_blank">www.einsatzkomponente.de</a> )</span></th>
        </tr>
	<?php endif; ?>
		</tfoot>
		<tbody>
...
?>" title="<?php echo $item->name; ?>"/>
       ...
       $canCheckin
				...
				<?php endif; ?>
				<a class="eiko_fahrzeug_link" href="<?php echo Route::_(
     ...
     ?>
					<?php if ($total): ?>
					<td  class="eiko_fahrzeug_letzter_einsatz  mobile_hide_480"><a href="<?php echo Route::_(
