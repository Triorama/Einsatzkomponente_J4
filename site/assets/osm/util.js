...
function setLayer(id) {
  if (document.getElementById('layer') != null) {
    for (var i = 0; i < layers.length; ++i) document.getElementById(layers[i][1]).className = ''
  }
  varName = layers[id][0]
  name = layers[id][1]
  map.setBaseLayer(varName)
  if (document.getElementById('layer') != null) document.getElementById(name).className = 'active'
}
/*
