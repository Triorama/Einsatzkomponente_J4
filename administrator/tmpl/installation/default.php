...
$repair_array = [];
$repair_array['111'] =
  "CREATE TABLE IF NOT EXISTS `#__eiko_einsatzkategorie` ( `id` int(11) unsigned NOT NULL AUTO_INCREMENT,  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',  `title` varchar(255) NOT NULL,  `image` varchar(255) NOT NULL,  `beschreibung` TEXT NOT NULL,  `ordering` int(11) NOT NULL,  `state` tinyint(1) NOT NULL,  `created_by` int(11) NOT NULL,  `checked_out` int(11) NOT NULL,  `checked_out_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',  PRIMARY KEY (`id`)) DEFAULT COLLATE=utf8_general_ci;";
...
$repair_array['114'] = 'ALTER TABLE `#__eiko_einsatzberichte` ADD `auswahl_orga` TEXT NOT NULL AFTER `einsatzkategorie`;';
...
// seit V4
$repair_array['119'] = 'ALTER TABLE `#__eiko_einsatzberichte` DROP `auswahlorga`;';
...
(1, 172, '12', 'HYBRID', 600, 300, '53.28071418254047,7.416630163574155|53.294772929932165,7.4492458251952485|53.29815865222114,7.4767116455077485|53.31313468829642,7.459888830566342|53.29949234792138,7.478256597900327|53.29815865222114,7.506409063720639|53.286461382800795,7.521686926269467|53.26726681991669,7.499027624511655|', '53.286871867528056', '7.475510015869147', 1, 1, '');";
        ...
        $check_einsatzkategorie = '0';
        $db = Factory::getDbo();
        $db->setQuery('select * from `#__eiko_einsatzkategorie`');
        try {
          $check_einsatzkategorie = $db->execute();
        } catch (Exception $e) {
          $check_einsatzkategorie = '1';
        }

        if ($check_einsatzkategorie == '1') {
          $eiko_einsatzkategorie = [
            [
              'id' => '1',
              'asset_id' => '0',
              'title' => 'Brandeinsatz > Brandmeldeanlage (Fehlalarm)',
              'image' => 'images/com_einsatzkomponente/images/list/brand_bma_fehl.png',
              'beschreibung' => '',
              'ordering' => '1',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '2',
              'asset_id' => '0',
              'title' => 'Brandeinsatz > Wohngebäude',
              'image' => 'images/com_einsatzkomponente/images/list/brand_wohnhaus.png',
              'beschreibung' => '',
              'ordering' => '2',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '3',
              'asset_id' => '0',
              'title' => 'Brandeinsatz > Fahrzeugbrand',
              'image' => 'images/com_einsatzkomponente/images/list/brand_pkw.png',
              'beschreibung' => '',
              'ordering' => '3',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '4',
              'asset_id' => '0',
              'title' => 'Brandeinsatz > Wald / Flächen',
              'image' => 'images/com_einsatzkomponente/images/list/brand_wald_flaechen.png',
              'beschreibung' => '',
              'ordering' => '4',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '5',
              'asset_id' => '0',
              'title' => 'Techn. Hilfe > Hochwasser',
              'image' => 'images/com_einsatzkomponente/images/list/TH_WASSER.png',
              'beschreibung' => '',
              'ordering' => '5',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '6',
              'asset_id' => '0',
              'title' => 'Techn. Hilfe > Öl / Benzin auf Straße',
              'image' => 'images/com_einsatzkomponente/images/list/hilfe_oelspur.png',
              'beschreibung' => '',
              'ordering' => '6',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '7',
              'asset_id' => '0',
              'title' => 'Techn. Hilfe > Öl / Benzin auf Gewässer',
              'image' => 'images/com_einsatzkomponente/images/list/hilfe_amtshilfe.png',
              'beschreibung' => '',
              'ordering' => '7',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '8',
              'asset_id' => '0',
              'title' => 'Techn. Rettung > Verkehrsunfall',
              'image' => 'images/com_einsatzkomponente/images/list/hilfe_pkw_unfall.png',
              'beschreibung' => '',
              'ordering' => '8',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '9',
              'asset_id' => '0',
              'title' => 'Techn. Rettung > Wasserrettung',
              'image' => 'images/com_einsatzkomponente/images/list/brand_sonstiges.png',
              'beschreibung' => '',
              'ordering' => '9',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '10',
              'asset_id' => '0',
              'title' => 'Techn. Rettung > Person in Notlage',
              'image' => 'images/com_einsatzkomponente/images/list/hilfe_amtshilfe.png',
              'beschreibung' => '',
              'ordering' => '10',
              'state' => '1',
            ...
            [
              'id' => '11',
              'asset_id' => '0',
              'title' => 'Techn. Hilfe > Sturm',
              'image' => 'images/com_einsatzkomponente/images/list/hilfe_sturm.png',
              'beschreibung' => '',
              'ordering' => '11',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '12',
              'asset_id' => '0',
              'title' => 'Med. Einsatz > First Responder',
              'image' => 'images/com_einsatzkomponente/images/list/med_sonstiges.png',
              'beschreibung' => '',
              'ordering' => '12',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '14',
              'asset_id' => '0',
              'title' => 'Gefahrgut > Leckage',
              'image' => 'images/com_einsatzkomponente/images/list/gefahr_sonstige.png',
              'beschreibung' => '',
              'ordering' => '14',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '15',
              'asset_id' => '0',
              'title' => 'Techn. Hilfe > sonstige techn. Hilfeleistung',
              'image' => 'images/com_einsatzkomponente/images/list/hilfe_amtshilfe.png',
              'beschreibung' => '',
              'ordering' => '15',
              'state' => '1',
            ...
            [
              'id' => '16',
              'asset_id' => '0',
              'title' => 'Techn. Rettung > sonstige techn. Rettung',
              'image' => 'images/com_einsatzkomponente/images/list/hilfe_amtshilfe.png',
              'beschreibung' => '',
              'ordering' => '16',
              'state' => '1',
            ...
            [
              'id' => '17',
              'asset_id' => '0',
              'title' => 'Brandeinsatz > Sonstiges',
              'image' => 'images/com_einsatzkomponente/images/list/Alarmuebung.png',
              'beschreibung' => '',
              'ordering' => '17',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '18',
              'asset_id' => '0',
              'title' => 'Med. Einsatz > sonstige medizinische Einsatz',
              'image' => 'images/com_einsatzkomponente/images/list/med_sonstiges.png',
              'beschreibung' => '',
              'ordering' => '18',
              'state' => '1',
            ...
            [
              'id' => '19',
              'asset_id' => '0',
              'title' => 'Brandeinsatz > Kleinbrand',
              'image' => 'images/com_einsatzkomponente/images/list/Sicherheitswache.png',
              'beschreibung' => '',
              'ordering' => '19',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '20',
              'asset_id' => '0',
              'title' => 'Brandeinsatz > Gewerbebetrieb',
              'image' => 'images/com_einsatzkomponente/images/list/brand_wohnhaus.png',
              'beschreibung' => '',
              'ordering' => '20',
              'state' => '1',
            ...
            [
              'id' => '21',
              'asset_id' => '0',
              'title' => 'Brandeinsatz > Industriebetrieb',
              'image' => 'images/com_einsatzkomponente/images/list/brand_wohnhaus.png',
              'beschreibung' => '',
              'ordering' => '21',
              'state' => '1',
            ...
            [
              'id' => '22',
              'asset_id' => '0',
              'title' => 'Brandeinsatz > Brandmeldeanlage',
              'image' => 'images/com_einsatzkomponente/images/list/brand_bma.png',
              'beschreibung' => '',
              'ordering' => '22',
              'state' => '1',
              'created_by' => '0',
            ...
            [
              'id' => '23',
              'asset_id' => '0',
              'title' => 'Gefahrgut > sonstiger Gefahrgut-Einsatz',
              'image' => 'images/com_einsatzkomponente/images/list/brand_sonstiges.png',
              'beschreibung' => '',
              'ordering' => '23',
              'state' => '1',
          ...
          $e = '';
          $sql = "CREATE TABLE IF NOT EXISTS `#__eiko_einsatzkategorie` (
`id` int(11)  UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
          ...
          foreach ($eiko_einsatzkategorie as $data) {
            $sql =
              'INSERT INTO `#__eiko_einsatzkategorie` (id, asset_id, title, image, beschreibung, ordering, state,created_by,checked_out,checked_out_time)
    VALUES ("' .
              $data['id'] .
              '", "' .
              $data['asset_id'] .
