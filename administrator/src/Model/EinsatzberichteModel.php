...
class EinsatzberichteModel extends ListModel {
    ...
    protected function populateState($ordering = null, $direction = null) {
		...
		//Filtering alerting
		$this->setState('filter.alerting', $this->getUserStateFromRequest($this->context.'.filter.alerting', 'filter_alerting', '', 'string'));

		//Filtering tickerkat
		$this->setState('filter.tickerkat', $this->getUserStateFromRequest($this->context.'.filter.tickerkat', 'filter_tickerkat', '', 'string'));

		//Filtering data1
		$this->setState('filter.data1', $this->getUserStateFromRequest($this->context.'.filter.data1', 'filter_data1', '', 'string'));

		//Filtering date1
		$this->setState('filter.date1.from', $this->getUserStateFromRequest($this->context.'.filter.date1.from', 'filter_from_date1', '', 'string'));
		$this->setState('filter.date1.to', $this->getUserStateFromRequest($this->context.'.filter.date1.to', 'filter_to_date1', '', 'string'));
