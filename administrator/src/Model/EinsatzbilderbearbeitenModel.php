 ...
 */
class EinsatzbilderbearbeitenModel extends AdminModel
{
	/**
 ...
 public function delete (&$pks)
    {
        ...
        foreach($pks as $id)
        {
			...
			if ($result[0]->image) : $delete_image = '../'.$result[0]->image; endif;
			if ($result[0]->thumb) : $delete_thumb = '../'.$result[0]->thumb; endif;
