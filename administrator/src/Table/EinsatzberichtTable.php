...
class EinsatzberichtTable extends Table
{
  ...
  public function bind($array, $ignore = '')
  {
    ...
    if (isset($array['auswahl_orga'])) {
      ...
      } elseif (strrpos($array['auswahl_orga'], ',') != false) {
    ...
    if (isset($array['vehicles'])) {
      ...
      } elseif (strrpos($array['vehicles'], ',') != false) {
    ...
    if (isset($array['ausruestung'])) {
      ...
      } elseif (strrpos($array['ausruestung'], ',') != false) {
    ...
    if (isset($array['params'])) {
      ...
      } elseif (strrpos($array['params'], ',') != false) {
    ...
    //        if(!JFactory::getUser()->authorise('core.admin', 'com_einsatzkomponente.einsatzbericht.'.$array['id'])){
    //            $actions = JFactory::getACL()->getActions('com_einsatzkomponente','einsatzbericht');
    //            $default_actions = JFactory::getACL()->getAssetRules('com_einsatzkomponente.einsatzbericht.'.$array['id'])->getData();
    //            $array_jaccess = array();
  ...
  //        $k = $this->_tbl_key;
  //        return 'com_einsatzkomponente.einsatzbericht.' . (int) $this->$k;
  //    }
  //
  //    /**
