  ...
  <tr>
	...
	<div class="eiko_navbar_2 " style="left"><?php echo $this->navbar; ?></div>
			...
			<?php if ($this->params->get('display_detail_einsatznummer', '0') == '1'): ?> 
			 <div class="text-muted eiko_detail_einsatznummer"><?php echo Text::_(
      '</br>(Einsatz-Nr.'
    ); ?> <?php echo $this->einsatznummer . ')'; ?></div> 
            <?php endif; ?>

    <!--Navigation ENDE-->
    </td>
    <!--<td class="layout4_row_2" style="border:hidden;">
    <span style="float:right;">Dieser Bericht wurde <?php echo $this->item
      ->counter; ?> mal gelesen</span>
    </td>-->
  </tr>
...
<table class="table table-bordered" border="1" style="width:100%;">  
 <?php if ($this->einsatzlogo->beschr): ?>
  <tr>
    ...
    ?>"  alt="<?php echo $this->einsatzlogo->title; ?>" title="<?php echo $this->einsatzlogo
  ->title; ?>" style="width:99%;margin:5px;"/>
    </td>
  </tr>
<?php endif; ?>

  <tr style="padding:10px;">
    <td class="layout4_row_6" width="250px"><?php echo Text::_(
      'COM_EINSATZKOMPONENTE_EINSATZART'
    ); ?></td>
    <td class="layout4_row_6" style="font-weight:bold;"><?php echo $this->einsatzlogo
      ->title; ?></td>
  </tr>
  
  <tr>
    <td class="layout4_row_7" width="250px"><?php echo Text::_(
      'COM_EINSATZKOMPONENTE_KURZBERICHT'
    ); ?></td>
    <td class="layout4_row_7"><?php echo $this->item->summary; ?></td>
  </tr>
  
  <tr>
    <td class="layout4_row_8" width="250px"><?php echo Text::_(
      'COM_EINSATZKOMPONENTE_EINSATZORT'
    ); ?></td>
    <td class="layout4_row_8"><?php echo $this->item->address . ''; ?></td>
  </tr>

  <tr>
    <td class="layout4_row_9" width="250px"><?php echo Text::_(
      'COM_EINSATZKOMPONENTE_ALERTING'
    ); ?></td>
...
<?php if ($this->alarmierungsart->image): ?>
    ...
    ?>"  alt="<?php echo $this->alarmierungsart->title; ?>" title="<?php echo $this->alarmierungsart
  ->title; ?>" width="32px"/><br/>
<?php endif; ?>
<?php if (!$this->alarmierungsart->image): ?>
...
<?php endif; ?>
 ...
 ?>
    ...
    am <?php echo $date2 .
      ...
      ''; ?>, um <?php echo date('H:i', strtotime($this->item->date1)) .
  ' ' .
  Text::_('COM_EINSATZKOMPONENTE_UHR'); ?>
    </td>
  </tr>
 ...
 <?php endif; ?>
  ...
  <tr>
    <td class="layout4_row_10" width="250px"><?php echo Text::_(
      'COM_EINSATZKOMPONENTE_MANNSCHAFTSSTARKE'
    ); ?></td>
  ...
  <tr>
    <td class="layout4_row_11" width="250px"><?php echo Text::_(
      'COM_EINSATZKOMPONENTE_EINSATZKRAEFTE'
    ); ?></td>
    <td class="layout4_row_11">
            <?php if ($this->item->auswahl_orga): ?>   
            <div class="well well-small">
			<?php echo '<span style="font-weight: bold;"><u>' .
     Text::_('COM_EINSATZKOMPONENTE_ORGANISATIONEN') .
     '</u></span>'; ?>
			<?php
   $array = [];
   ...
   ?>
            ...
            <?php if ($this->item->vehicles): ?>
			<?php echo '<span><u><b>' .
     Text::_('COM_EINSATZKOMPONENTE_EINSATZFAHRZEUGE') .
     '</b></u></span><br/>'; ?>
...
<?php if ($this->params->get('display_detail_desc', '1')): ?>
  <tr>
    <td  class="layout4_row_12" colspan="2">
		<b><u class="einsatzbericht-title"><?php echo Text::_(
