...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		{
			ToolbarHelper::apply('einsatzbericht.apply', 'Toolbar_APPLY');
			ToolbarHelper::save('einsatzbericht.save', 'Toolbar_SAVE');
		}
		if (!$checkedOut && ($canDo->get('core.create'))){
			ToolbarHelper::custom('einsatzbericht.save2new', 'save-new.png', 'save-new_f2.png', 'Toolbar_SAVE_AND_NEW', false);
		}
		// If an existing item, can save to a copy.
		if (!$isNew && $canDo->get('core.create')) {
			ToolbarHelper::custom('einsatzbericht.save2copy', 'save-copy.png', 'save-copy_f2.png', 'Toolbar_SAVE_AS_COPY', false);
		}
		if (empty($this->item->id)) {
			ToolbarHelper::cancel('einsatzbericht.cancel', 'Toolbar_CANCEL');
		}
		else {
			ToolbarHelper::cancel('einsatzbericht.cancel', 'Toolbar_CLOSE');
		}
