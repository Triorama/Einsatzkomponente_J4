...
<?php if ($this->item): ?>  <!--Einsatzdaten vorhanden ? Sonst ENDE --> 
         ...
         ?>"  alt="" title="<?php echo Text::_($this->tickerKat->title); ?>"/>
            <?php endif; ?>
            <?php endif; ?>
			
			<?php if ($this->params->get('display_detail_einsatzart_icon', '0') == '1'): ?> 
            <?php if (isset($this->einsatzlogo->list_icon)): ?>
        	<img  class="eiko_img-rounded_2 eiko_list_icon_3 mobile_hide_320" src="<?php
         echo JURI::Root();
         echo $this->einsatzlogo->list_icon;
         ?>"  alt="eiko_list_icon" title="<?php echo Text::_($this->einsatzlogo->title); ?>"/>
            <?php endif; ?>
            <?php endif; ?>
