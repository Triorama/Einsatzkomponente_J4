...
if ($saveOrder) {
  $saveOrderingUrl =
    'index.php?option=com_einsatzkomponente&task=alarmierungsarten.saveOrderAjax&tmpl=component';
  HTMLHelper::_(
...
<?php endif; ?>
  ...
  $this->state->get('filter.search')
      ...
      'JFIELD_ORDERING_DESC'
       ...
       echo 'selected="selected"';
        ...
        'JGLOBAL_CHECK_ALL'
				...
				<?php echo HTMLHelper::_(
      'grid.sort',
      'COM_EINSATZKOMPONENTE_ALARMIERUNGSARTEN_TITLE',
      'a.title',
      $listDirn,
      $listOrder
    ); ?>
				...
				<?php echo HTMLHelper::_(
      'grid.sort',
      'COM_EINSATZKOMPONENTE_ALARMIERUNGSARTEN_IMAGE',
      'a.image',
      $listDirn,
      $listOrder
    ); ?>
				...
				<?php echo HTMLHelper::_(
      'grid.sort',
      'COM_EINSATZKOMPONENTE_ALARMIERUNGSARTEN_CREATED_BY',
      'a.created_by',
      $listDirn,
      $listOrder
    ); ?>
     ...
     ?>
       ...
       'index.php?option=com_einsatzkomponente&task=alarmierungsart.edit&id=' . (int) $item->id
     ); ?>">
    ...
    $query =
      'SELECT count(id) FROM #__eiko_einsatzberichte WHERE alerting = "' .
      $item->id .
