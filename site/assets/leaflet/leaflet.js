...
!(function (t, i) {
  ...
  function ki(i, t, e, n) {
    ...
    Lt && 0 === t.indexOf('touch')
      ? jt(i, t, c, o)
      : bt && 'dblclick' === t && !Zi()
        ? ((r = c), (l = !1), ((s = i)[Gt + Vt + (a = o)] = d), (s[Gt + qt + a] = p), (s[Gt + 'dblclick' + a] = r), s.addEventListener(Vt, d, !!Ct && { passive: !1 }), s.addEventListener(qt, p, !!Ct && { passive: !1 }), s.addEventListener('dblclick', r, !1))
  ...
  function Bi(t, i, e, n) {
    ...
    Lt && 0 === i.indexOf('touch')
      ? ((c = (u = t)['_leaflet_' + (l = i) + _]), 'touchstart' === l ? u.removeEventListener(At, c, !1) : 'touchmove' === l ? u.removeEventListener(It, c, !1) : 'touchend' === l && (u.removeEventListener(Ot, c, !1), u.removeEventListener(Rt, c, !1)))
      : bt && 'dblclick' === i && !Zi()
        ? ((r = (o = t)[Gt + Vt + (s = _)]), (a = o[Gt + qt + s]), (h = o[Gt + 'dblclick' + s]), o.removeEventListener(Vt, r, !!Ct && { passive: !1 }), o.removeEventListener(qt, a, !!Ct && { passive: !1 }), o.removeEventListener('dblclick', h, !1))
  ...
  var qi = {
    ...
    Gi = E.extend({
      run: function (t, i, e, n) {
        this.stop(), (this._el = t), (this._inProgress = !0), (this._duration = e || 0.25), (this._easeOutPower = 1 / Math.max(n || 0.5, 0.2)), (this._startPos = yi(t)), (this._offset = i.subtract(this._startPos)), (this._startTime = +new Date()), this.fire('start'), this._animate()
      },
      stop: function () {
    ...
    Ki = E.extend({
      ...
      setView: function (t, i, e) {
        if (
          ...
          (void 0 !== e.animate && ((e.zoom = h({ animate: e.animate }, e.zoom)), (e.pan = h({ animate: e.animate, duration: e.duration }, e.pan))), this._zoom !== i ? this._tryAnimatedZoom && this._tryAnimatedZoom(t, i, e.zoom) : this._tryAnimatedPan(t, e.pan))
        )
          ...
          (t = A(t).round()).x || t.y
            ? (!0 === i.animate || this.getSize().contains(t)
                ? (this._panAnim || ((this._panAnim = new Gi()), this._panAnim.on({ step: this._onPanTransitionStep, end: this._onPanTransitionEnd }, this)),
                  ...
                  !1 !== i.animate ? (ci(this._mapPane, 'leaflet-pan-anim'), (e = this._getMapPanePos().subtract(t).round()), this._panAnim.run(this._mapPane, e, i.duration || 0.25, i.easeLinearity)) : (this._rawPanBy(t), this.fire('move').fire('moveend')))
      ...
      invalidateSize: function (t) {
        ...
        var e = this.getSize(),
          ...
          s = n.subtract(o)
        return s.x || s.y
          ? (t.animate && t.pan ? this.panBy(s) : (t.pan && this._rawPanBy(s), this.fire('move'), t.debounceMoveend ? (clearTimeout(this._sizeTimer), (this._sizeTimer = setTimeout(p(this.fire, this, 'moveend'), 200))) : this.fire('moveend')), this.fire('resize', { oldSize: i, newSize: e }))
          : this
      },
      stop: function () {
      ...
      _animateZoom: function (t, i, e, n) {
        this._mapPane && (e && ((this._animatingZoom = !0), (this._animateToCenter = t), (this._animateToZoom = i), ci(this._mapPane, 'leaflet-zoom-anim')), this.fire('zoomanim', { center: t, zoom: i, noUpdate: n }), setTimeout(p(this._onZoomTransitionEnd, this), 250))
      },
      ...
      _onDown: function (t) {
        ...
        !t._simulated &&
          ...
          li(this._element, 'leaflet-zoom-anim') ||
            ...
            xi(),
            Xt(),
            this._moving || (this.fire('down'), (i = t.touches ? t.touches[0] : t), (e = bi(this._element)), (this._startPoint = new k(i.clientX, i.clientY)), (this._parentScale = Ti(e)), zi(document, re[t.type], this._onMove, this), zi(document, se[t.type], this._onUp, this))))
      },
      _onMove: function (t) {
        var i, e
        !t._simulated &&
  ...
  Ki.include({
    ...
    removeLayer: function (t) {
      ...
      return (
        this._layers[i] &&
          (this._loaded && t.onRemove(this), t.getAttribution && this.attributionControl && this.attributionControl.removeAttribution(t.getAttribution()), delete this._layers[i], this._loaded && (this.fire('layerremove', { layer: t }), t.fire('remove')), (t._map = t._mapToAdd = null)),
        this
      )
    },
    hasLayer: function (t) {
  ...
  var Ze = Se.extend({
    ...
    Ee = ie.extend({
      ...
      _adjustPan: function (t) {
        ...
        u.contains(r) ||
          ((i = A((Math.max(u.max.x, r.x) - u.max.x) / (a.max.x - u.max.x) - (Math.min(u.min.x, r.x) - u.min.x) / (a.min.x - u.min.x), (Math.max(u.max.y, r.y) - u.max.y) / (a.max.y - u.max.y) - (Math.min(u.min.y, r.y) - u.min.y) / (a.min.y - u.min.y)).multiplyBy(o)),
          n.panBy(i, { animate: !1 }),
  ...
  var Oe = Be.extend({
    ...
    _clipPoints: function () {
      ...
      if (((this._parts = []), this._pxBounds && this._pxBounds.intersects(t)))
        ...
        else for (var i, e, n, o, s = this._parts, r = 0, a = 0, h = this._rings.length; r < h; r++) for (i = 0, e = (o = this._rings[r]).length; i < e - 1; i++) (n = le(o[i], o[i + 1], t, i, !0)) && ((s[a] = s[a] || []), s[a].push(n[0]), (n[1] === o[i + 1] && i !== e - 2) || (s[a].push(n[1]), a++))
    },
    ...
    Me.include({
      ...
      _initTooltipInteractions: function (t) {
        ...
        ;(!t && this._tooltipHandlersAdded) ||
          ...
          this._tooltip.options.permanent ? (e.add = this._openTooltip) : ((e.mouseover = this._openTooltip), (e.mouseout = this.closeTooltip), this._tooltip.options.sticky && (e.mousemove = this._moveTooltip), bt && (e.click = this._openTooltip)),
          this[i](e),
          (this._tooltipHandlersAdded = !t))
      },
      openTooltip: function (t, i) {
        return (
          this._tooltip && this._map && ((i = this._tooltip._prepareOpen(this, t, i)), this._map.openTooltip(this._tooltip, i), this._tooltip.options.interactive && this._tooltip._container && (ci(this._tooltip._container, 'leaflet-clickable'), this.addInteractiveTarget(this._tooltip._container))),
          this
        )
      },
  ...
  var hn = Me.extend({
    ...
    un = hn.extend({
      ...
      _updateCircle: function (t) {
        ...
        this._drawing &&
          !t._empty() &&
          ((i = t._point), (e = this._ctx), (n = Math.max(Math.round(t._radius), 1)), 1 != (o = (Math.max(Math.round(t._radiusY), 1) || n) / n) && (e.save(), e.scale(1, o)), e.beginPath(), e.arc(i.x, i.y / o, n, 0, 2 * Math.PI, !1), 1 != o && e.restore(), this._fillStroke(e, t))
      },
  ...
  var gn = ie.extend({
    ...
    _onMouseUp: function (t) {
      ...
      ;(1 !== t.which && 1 !== t.button) ||
        (this._finish(),
        this._moved &&
          (this._clearDeferredResetState(), (this._resetStateTimeout = setTimeout(p(this._resetState, this), 0)), (i = new R(this._map.containerPointToLatLng(this._startPoint), this._map.containerPointToLatLng(this._point))), this._map.fitBounds(i).fire('boxzoomend', { boxZoomBounds: i })))
    },
