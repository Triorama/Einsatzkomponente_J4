     ...
     if ($this->params->get('display_detail_fhz_links', '1')):
       if (!$results[0]->link):
         ...
         $vehicles_images[] =
           '<span style="margin-right:10px;background-color:#D8D8D8;white-space:nowrap;"><a href="' .
           $results[0]->link .
           '" target="_blank"><img width="40px" style="margin-top:15px;" src="' .
           JURI::Root() .
           $results[0]->image .
           '"  alt="' .
           $results[0]->name .
       ...
       if ($results[0]->link):
         ...
         $vehicles_images[] =
           '<span style="margin-right:10px;background-color:#D8D8D8;white-space:nowrap;"><img width="40px" style="margin-top:15px;" src="' .
           JURI::Root() .
           $results[0]->image .
           '"  alt="' .
           $results[0]->name .
