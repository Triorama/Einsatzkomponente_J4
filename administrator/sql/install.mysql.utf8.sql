CREATE TABLE IF NOT EXISTS `#__eiko_einsatzberichte` (
  ...
  `article_id` varchar(255) DEFAULT '0',
  `ordering` int(11) NOT NULL,
  `einsatzart` int(10) DEFAULT NULL,
  `image` varchar(255) DEFAULT NULL,
  `address` varchar(255) DEFAULT NULL,
  `alarmierungszeit` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `ausfahrtszeit` datetime DEFAULT '0000-00-00 00:00:00',
  `einsatzende` datetime DEFAULT '0000-00-00 00:00:00',
  `summary` varchar(255) DEFAULT NULL,
  `einsatzleiter` varchar(255) DEFAULT NULL,
  `einsatzfuehrer` varchar(255) DEFAULT NULL,
  `people` varchar(255) DEFAULT NULL,
  `department` int(11) DEFAULT NULL,
  `desc` text DEFAULT NULL,
  `alarmierungsart` text NOT NULL,
  `gmap_report_latitude` varchar(255) DEFAULT NULL,
  `gmap_report_longitude` varchar(255) DEFAULT NULL,
  `counter` int(20) NOT NULL,
  `gmap` varchar(255) DEFAULT NULL,
  `status_fb` varchar(255) DEFAULT '1',
  `presse_label` varchar(255) DEFAULT 'Presselink',
  `presse` varchar(255) DEFAULT NULL,
  `presse2_label` varchar(255) DEFAULT 'Presselink',
  `presse2` varchar(255) DEFAULT NULL,
  `presse3_label` varchar(255) DEFAULT 'Presselink',
  `presse3` varchar(255) DEFAULT NULL,
  `updatedate` datetime NOT NULL,
  `createdate` datetime NOT NULL,
  `einsatzticker` varchar(255) DEFAULT NULL,
  `notrufticker` varchar(255) DEFAULT NULL,
  `einsatzkategorie` int(10) NOT NULL,
  `auswahl_orga` text NOT NULL,
  `vehicles` text DEFAULT NULL,
  `ausruestung` text DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__eiko_organisationen` (
  ...
  `gmap_latitude` VARCHAR(255),
  `gmap_longitude` VARCHAR(255),
